...
### PLOTTING COMPARISON ###
matplot(theta, cbind(risk_N_1, risk_N_2, risk_N_3, risk_N_1_I), xlim = c(0.2, 2), ylim = c(0, 0.14),
        xlab = expression(paste("Values of ", theta)), ylab = "Risk Values", pch = c(16, 5, 14, 2),
        col = c("blue3", "green4", "blueviolet", "red"))
legend(1.3, 0.14, legend = c("N_1 estimator", "N_2 estimator", "N_3 estimator","N_1_I estimator"),
