...
matplot(theta, cbind(risk_umru, risk_umru_dom, risk_natural_1, risk_natural_1_dom, risk_natural_2),
        xlim = c(0.2, 1.2), ylim = c(0.005, 0.05), xlab = expression(paste("Values of ", theta)), ylab = "Risk Values",
        pch = c(16, 5, 14, 2), col = c("blue3", "green4", "blueviolet", "red", "burlywood3"))
legend(0.85, 0.05, legend = c("UMRU estimator", "dominated UMRU estimator", "first natural estimator",
